...
const CardProfile = ({ user }) => {
  ...
  return (
    <>
      <div
        data-theme="cupcake"
        className=" p-6 rounded-lg overflow-hidden shadow-md"
      >
          ...
          {user ? (
            <>
              ...
              <p className="text-gray-600">
                Motto Hidup: {user.email || "Tidak Memiliki Motto  Hidup"}
              </p>
              <Button
                onPress={onOpen}
                className="mt-4 border px-4 py-2 rounded-lg hover:bg-gray-100 active:bg-gray-200"
              >
                Detail
              </Button>
              <Modal
                ...
                >
                  {(onClose) => (
                    <>
                      ...
                      <ModalBody
                        className=" bg-neutral-100 w-full border px-4 py-2 border-slate-100"
                        data-theme=""
                      >
                        <Image
                          src={`/profile/${user.avatar}`}
                        ...
                        <p className="">
                          Motto Hidup:{" "}
                          {user.email || "Tidak Memiliki Motto Hidup"}
                        </p>
                        <p className="">
                          Jenis Kelamin:{" "}
                        ...
                        <p className="">
                          Alamat: {user.address || "Alamat Tidak Ditemukan"}
                        </p>
                        {user.sosialig && (
                          <>
