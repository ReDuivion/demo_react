        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="sm:hidden cursor-pointer relative">
              <div
                className={`w-6 h-6 items-end text-slate-600 ${
                  isDropdownVisible ? "-ml-2" : "ml-2"
                }`}
              ...
              {isDropdownVisible && (
                <div className="absolute right-0 mt-2 p-2 bg-white border shadow-lg w-40">
                  <Link
                    href="/service1"
                    className="text-gray-800 text-sm hover:text-purple-600 mb-1 block"
                  >
                    Home
                  </Link>
                  <Link
                  ...
                  <Link
                    href="/service3"
                    className="text-gray-800 text-sm hover:text-purple-600 block mb-1"
                  >
                    Contact
                  </Link>
                  <Link
                  ...
                  <Link
                    href="/Profiles"
                    className="text-gray-800 text-sm hover:text-purple-600 block"
                  >
                    List Siswa
                  </Link>
                </div>
