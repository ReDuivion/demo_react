  ...
  return (
    <>
      <div class="border-2 border-violet-300 w-96 rounded-lg max-w-full mx-auto">
        ...
        <hr />
        <hr className="" />
        <a className="m-5 text-slate-300 hover:text-sky-700" href="">
          *Belum punya akun?
        </a>
        <div className="">
        ...
        <div className="text-center">
          <button className="bg-violet-500 rounded-md text-white mx-5 my-2 w-2/3 hover:bg-violet-400 hover:text-violet-500">
            Login
          </button>
        </div>
      </div>
